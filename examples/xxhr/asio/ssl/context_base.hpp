...
#ifndef XXHR_ASIO_SSL_CONTEXT_BASE_HPP
#define XXHR_ASIO_SSL_CONTEXT_BASE_HPP
...
//
  ...
  BOOST_ASIO_STATIC_CONSTANT(int, verify_none = 0);
  BOOST_ASIO_STATIC_CONSTANT(int, verify_peer = 1);
  BOOST_ASIO_STATIC_CONSTANT(int, verify_fail_if_no_peer_cert = 2);
  BOOST_ASIO_STATIC_CONSTANT(int, verify_client_once = 3);
#endif
...
#endif // XXHR_ASIO_SSL_CONTEXT_BASE_HPP
