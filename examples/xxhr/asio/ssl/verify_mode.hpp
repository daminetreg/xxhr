...
#ifndef XXHR_ASIO_SSL_VERIFY_MODE_HPP
#define XXHR_ASIO_SSL_VERIFY_MODE_HPP
...
const int verify_fail_if_no_peer_cert = 2;
const int verify_client_once = 3;
#endif
...
#endif // XXHR_ASIO_SSL_VERIFY_MODE_HPP
